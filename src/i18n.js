...
export const STRINGS = {
  zh: {
    ...
    portrait: '纵向',
    landscape: '横向',
    settingsApplyNext: '设置将在下次打印时生效',
    converting: '转换中...',
    retry: '重试',
    printingLocked: '正在打印的文件无法移除',
  },
  en: {
    ...
    cancelPrintingLocked: 'Cancelling, please wait',
    ...
    portrait: 'Portrait',
    landscape: 'Landscape',
    settingsApplyNext: 'Settings take effect on next print',
    converting: 'Converting...',
    retry: 'Retry',
    printingLocked: 'Cannot remove the file currently being printed',
  },
};
